...
exports.run = async (client, message, args) => {
    ...
    .setFooter(`${message.author.tag} | Cathedral ♡ STAT`)
    .setThumbnail(message.author.avatarURL({dynamic: true}))
    .setDescription(`Toplam etkinliğinizi burada görebilir ve bu sunucudaki etkinlik ve listeyle ilgili bilgileri aşağıda bulabilirsiniz..`)
    .addField("Voice | Sıralama", `** **\n${voiceList}`)
    .addField("Message | Sıralama", `** **\n${messageList}`);
